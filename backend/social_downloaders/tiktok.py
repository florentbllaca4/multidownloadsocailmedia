...
def download_tiktok(urls):
    ...
    for url in urls:
        try:
            ...
            filename = f"tiktok_{uuid4().hex}.mp4"
            ...
            print("Gabim gjatë shkarkimit nga TikTok:", str(e))
    ...
    zip_path = os.path.join(DOWNLOAD_DIR, "tiktok_downloads.zip")
